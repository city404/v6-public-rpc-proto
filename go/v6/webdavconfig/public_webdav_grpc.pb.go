...
func (c *pubDavConfigClient) Get(ctx context.Context, in *DavConfig, opts ...grpc.CallOption) (*DavConfig, error) {
	...
	out := new(DavConfig)
	err := c.cc.Invoke(ctx, PubDavConfig_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubDavConfigClient) Update(ctx context.Context, in *DavConfig, opts ...grpc.CallOption) (*DavConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DavConfig)
	err := c.cc.Invoke(ctx, PubDavConfig_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubDavConfigClient) Enable(ctx context.Context, in *DavConfig, opts ...grpc.CallOption) (*DavConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DavConfig)
	err := c.cc.Invoke(ctx, PubDavConfig_Enable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubDavConfigClient) Disable(ctx context.Context, in *DavConfig, opts ...grpc.CallOption) (*DavConfig, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DavConfig)
	err := c.cc.Invoke(ctx, PubDavConfig_Disable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubDavConfigClient) ValidateUserName(ctx context.Context, in *DavConfig, opts ...grpc.CallOption) (*common.UserNameValidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, PubDavConfig_ValidateUserName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPubDavConfigServer must be embedded to have
...
func RegisterPubDavConfigServer(s grpc.ServiceRegistrar, srv PubDavConfigServer) {
	// If the following call panics, it indicates UnimplementedPubDavConfigServer was

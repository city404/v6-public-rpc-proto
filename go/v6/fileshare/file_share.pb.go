...
const file_share_file_share_proto_rawDesc = "" +
	"\n" +
	"\x16share/file_share.proto\x12\x0fv6.services.pub\x1a\x17common/pub_common.proto\"\x86\x04\n" +
	"\tFileShare\x12\x1a\n" +
	"\bidentity\x18\x01 \x01(\tR\bidentity\x12#\n" +
	"\ruser_identity\x18\x02 \x01(\tR\fuserIdentity\x12\x12\n" +
	"\x04type\x18\x03 \x01(\x05R\x04type\x12\x1b\n" +
	"\tmime_type\x18\x04 \x01(\tR\bmimeType\x12\x12\n" +
	"\x04name\x18\x05 \x01(\tR\x04name\x12\x1b\n" +
	"\tpath_list\x18\x06 \x03(\tR\bpathList\x12!\n" +
	"\fhas_password\x18\a \x01(\bR\vhasPassword\x12\x1a\n" +
	"\bpassword\x18\b \x01(\tR\bpassword\x12\x1a\n" +
	"\blifetime\x18\t \x01(\x03R\blifetime\x12\x1d\n" +
	"\n" +
	"save_limit\x18\n" +
	" \x01(\x03R\tsaveLimit\x12\x1d\n" +
	"\n" +
	"save_count\x18\v \x01(\x03R\tsaveCount\x12\x12\n" +
	"\x04like\x18\f \x01(\x03R\x04like\x12\x18\n" +
	"\adislike\x18\r \x01(\x03R\adislike\x12\x1b\n" +
	"\tcreate_ts\x18\x0e \x01(\x03R\bcreateTs\x12\x1b\n" +
	"\tupdate_ts\x18\x0f \x01(\x03R\bupdateTs\x12\x1b\n" +
	"\texpire_ts\x18\x10 \x01(\x03R\bexpireTs\x12\x1b\n" +
	"\tfile_size\x18\x11 \x01(\x03R\bfileSize\x12\x1b\n" +
	"\tsave_path\x18\x12 \x01(\tR\bsavePath\"\x81\x01\n" +
	"\x14FileShareListRequest\x12#\n" +
	"\ruser_identity\x18\x01 \x01(\tR\fuserIdentity\x12D\n" +
	"\tlist_info\x18\x03 \x01(\v2'.v6.services.pub.common.ScanListRequestR\blistInfo\"\x91\x01\n" +
	"\x15FileShareListResponse\x122\n" +
	"\x06shares\x18\x01 \x03(\v2\x1a.v6.services.pub.FileShareR\x06shares\x12D\n" +
	"\tlist_info\x18\x02 \x01(\v2'.v6.services.pub.common.ScanListRequestR\blistInfo\"4\n" +
	"\x16FileShareDeleteRequest\x12\x1a\n" +
	"\bidentity\x18\x01 \x03(\tR\bidentity\"/\n" +
	"\x17FileShareDeleteResponse\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count\"\xb5\x02\n" +
	"\tComplaint\x12\x1a\n" +
	"\bidentity\x18\x01 \x01(\tR\bidentity\x12#\n" +
	"\ruser_identity\x18\x02 \x01(\tR\fuserIdentity\x12.\n" +
	"\x13file_share_identity\x18\x03 \x01(\tR\x11fileShareIdentity\x127\n" +
	"\x18file_share_user_identity\x18\x04 \x01(\tR\x15fileShareUserIdentity\x12\x18\n" +
	"\acontent\x18\x05 \x01(\tR\acontent\x12\x1b\n" +
	"\tcreate_ts\x18\x06 \x01(\x03R\bcreateTs\x12\x1b\n" +
	"\tupdate_ts\x18\a \x01(\x03R\bupdateTs\x12\x16\n" +
	"\x06status\x18\b \x01(\x05R\x06status\x12\x12\n" +
	"\x04flag\x18\t \x01(\x05R\x04flag\"\\\n" +
	"\x14ComplaintListRequest\x12D\n" +
	"\tlist_info\x18\x03 \x01(\v2'.v6.services.pub.common.ScanListRequestR\blistInfo\"\x99\x01\n" +
	"\x15ComplaintListResponse\x12:\n" +
	"\n" +
	"complaints\x18\x01 \x03(\v2\x1a.v6.services.pub.ComplaintR\n" +
	"complaints\x12D\n" +
	"\tlist_info\x18\x02 \x01(\v2'.v6.services.pub.common.ScanListRequestR\blistInfo\"4\n" +
	"\x16ComplaintDeleteRequest\x12\x1a\n" +
	"\bidentity\x18\x01 \x03(\tR\bidentity\"/\n" +
	"\x17ComplaintDeleteResponse\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count2\xaa\x06\n" +
	"\fPubFileShare\x12B\n" +
	"\x06Create\x12\x1a.v6.services.pub.FileShare\x1a\x1a.v6.services.pub.FileShare\"\x00\x12?\n" +
	"\x03Get\x12\x1a.v6.services.pub.FileShare\x1a\x1a.v6.services.pub.FileShare\"\x00\x12@\n" +
	"\x04Like\x12\x1a.v6.services.pub.FileShare\x1a\x1a.v6.services.pub.FileShare\"\x00\x12C\n" +
	"\aDislike\x12\x1a.v6.services.pub.FileShare\x1a\x1a.v6.services.pub.FileShare\"\x00\x12J\n" +
	"\x0eComplaintShare\x12\x1a.v6.services.pub.Complaint\x1a\x1a.v6.services.pub.Complaint\"\x00\x12W\n" +
	"\x04List\x12%.v6.services.pub.FileShareListRequest\x1a&.v6.services.pub.FileShareListResponse\"\x00\x12`\n" +
	"\rListComplaint\x12%.v6.services.pub.ComplaintListRequest\x1a&.v6.services.pub.ComplaintListResponse\"\x00\x12]\n" +
	"\x06Delete\x12'.v6.services.pub.FileShareDeleteRequest\x1a(.v6.services.pub.FileShareDeleteResponse\"\x00\x12f\n" +
	"\x0fDeleteComplaint\x12'.v6.services.pub.ComplaintDeleteRequest\x1a(.v6.services.pub.ComplaintDeleteResponse\"\x00\x12@\n" +
	"\x04Save\x12\x1a.v6.services.pub.FileShare\x1a\x1a.v6.services.pub.FileShare\"\x00B8Z6github.com/city404/v6-public-rpc-proto/go/v6/fileshareb\x06proto3"

var (
	file_share_file_share_proto_rawDescOnce sync.Once
	file_share_file_share_proto_rawDescData []byte
)

func file_share_file_share_proto_rawDescGZIP() []byte {
	file_share_file_share_proto_rawDescOnce.Do(func() {
		file_share_file_share_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_share_file_share_proto_rawDesc), len(file_share_file_share_proto_rawDesc)))
	})
...
func file_share_file_share_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_share_file_share_proto_rawDesc), len(file_share_file_share_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,

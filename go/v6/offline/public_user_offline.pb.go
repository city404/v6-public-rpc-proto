...
type TaskParseResponse struct {
	...
	Data []*TaskParseData `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *TaskParseResponse) GetData() []*TaskParseData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *TaskParseData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TaskParseData) ProtoMessage() {}

func (x *TaskParseData) ProtoReflect() protoreflect.Message {
	mi := &file_offline_public_user_offline_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TaskParseData.ProtoReflect.Descriptor instead.
func (*TaskParseData) Descriptor() ([]byte, []int) {
	return file_offline_public_user_offline_proto_rawDescGZIP(), []int{4}
}

func (x *TaskParseData) GetMeta() *TaskMeta {
	if x != nil {
		return x.Meta
	}
	return nil
...
func (x *TaskParseData) GetFiles() []*TaskFile {
	if x != nil {
		return x.Files
	}
	return nil
...
var file_offline_public_user_offline_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x36, 0x5a,
...
var file_offline_public_user_offline_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_offline_public_user_offline_proto_goTypes = []interface{}{
	...
	(*TaskParseData)(nil),     // 4: v6.services.pub.TaskParseData
}
var file_offline_public_user_offline_proto_depIdxs = []int32{
	4, // 0: v6.services.pub.TaskParseResponse.data:type_name -> v6.services.pub.TaskParseData
	1, // 1: v6.services.pub.TaskParseData.meta:type_name -> v6.services.pub.TaskMeta
	2, // 2: v6.services.pub.TaskParseData.files:type_name -> v6.services.pub.TaskFile

...
func (x *TaskMeta) GetRetries() int64 {
	if x != nil {
		return x.Retries
	}
	return 0
...
func (x *TaskMeta) GetProgress() int64 {
	if x != nil {
		return x.Progress
	}
	return 0
...
func (x *TaskMeta) GetBytesTotal() int64 {
	if x != nil {
		return x.BytesTotal
	}
	return 0
...
func (x *TaskMeta) GetBytesProcessed() int64 {
	if x != nil {
...
type UserTask struct {
	...
	SaveIdentity   string   `protobuf:"bytes,23,opt,name=save_identity,json=saveIdentity,proto3" json:"save_identity,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_offline_public_user_offline_proto_rawDesc = "" +
	...
	"\aretries\x18\x0f \x01(\x03R\aretries\x12\x1a\n" +
	...
	"\x05count\x18\x01 \x01(\x03R\x05count\"\xc0\x04\n" +
	"\bUserTask\x12\x1a\n" +
	"\bidentity\x18\x01 \x01(\tR\bidentity\x12\x12\n" +
	"\x04type\x18\x02 \x01(\x05R\x04type\x12\x16\n" +
	...
	"\fignore_files\x18\x16 \x03(\tR\vignoreFiles\x12#\n" +
	"\rsave_identity\x18\x17 \x01(\tR\fsaveIdentity2\xe4\x03\n" +

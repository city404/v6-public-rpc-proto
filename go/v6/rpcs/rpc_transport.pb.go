...
var file_rpcs_rpc_transport_proto_goTypes = []interface{}{
...
func file_rpcs_rpc_transport_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpcs_rpc_transport_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpcs_rpc_transport_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpcs_rpc_transport_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {

...
func file_common_pub_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_pub_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_common_pub_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_common_pub_common_proto_msgTypes[2].Exporter = func(v any, i int) any {

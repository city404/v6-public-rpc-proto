...
const (
	...
	PubUserFile_GetDirectDownloadAddress_FullMethodName  = "/v6.services.pub.PubUserFile/GetDirectDownloadAddress"
	...
	PubUserFile_ListRecentUpdatedFiles_FullMethodName    = "/v6.services.pub.PubUserFile/ListRecentUpdatedFiles"
)
...
type PubUserFileClient interface {
	...
	// ListRecentUpdatedFiles
	ListRecentUpdatedFiles(ctx context.Context, in *ListRecentUpdatedFilesRequest, opts ...grpc.CallOption) (*FileListResponse, error)
}
...
func (c *pubUserFileClient) ListRecentUpdatedFiles(ctx context.Context, in *ListRecentUpdatedFilesRequest, opts ...grpc.CallOption) (*FileListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FileListResponse)
	err := c.cc.Invoke(ctx, PubUserFile_ListRecentUpdatedFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PubUserFileServer interface {
	...
	// ListRecentUpdatedFiles
	ListRecentUpdatedFiles(context.Context, *ListRecentUpdatedFilesRequest) (*FileListResponse, error)
...
func (UnimplementedPubUserFileServer) DeleteTrash(context.Context, *BatchOperationRequest) (*BatchOperationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteTrash not implemented")
}
...
func (UnimplementedPubUserFileServer) BatchRename(context.Context, *BatchOperationRequest) (*BatchOperationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchRename not implemented")
}
func (UnimplementedPubUserFileServer) BatchOperation(context.Context, *BatchOperationRequest) (*BatchOperationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchOperation not implemented")
}
...
func (UnimplementedPubUserFileServer) CreateManageRTCOffer(context.Context, *ManageRTCRequest) (*ManageRTCResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateManageRTCOffer not implemented")
}
func (UnimplementedPubUserFileServer) SendClientIceCandidate(context.Context, *SendIceCandidateRequest) (*SendIceCandidateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendClientIceCandidate not implemented")
}
func (UnimplementedPubUserFileServer) GetServerIceCandidate(context.Context, *GetIceCandidateRequest) (*GetIceCandidateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetServerIceCandidate not implemented")
}
func (UnimplementedPubUserFileServer) ParseFileSlice(context.Context, *File) (*ParseFileSliceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ParseFileSlice not implemented")
}
func (UnimplementedPubUserFileServer) GetSliceDownloadAddress(context.Context, *SliceDownloadAddressRequest) (*SliceDownloadAddressResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSliceDownloadAddress not implemented")
}
func (UnimplementedPubUserFileServer) GetDirectDownloadAddress(context.Context, *DirectDownloadRequest) (*FileDownloadAddressResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDirectDownloadAddress not implemented")
}
func (UnimplementedPubUserFileServer) GetDownloadAndPreviewInfo(context.Context, *File) (*DownloadAndPreviewInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDownloadAndPreviewInfo not implemented")
}
func (UnimplementedPubUserFileServer) PreviewDoc(context.Context, *File) (*DocFilePreview, error) {
	return nil, status.Error(codes.Unimplemented, "method PreviewDoc not implemented")
}
...
func (UnimplementedPubUserFileServer) CreateTemporaryUpload(context.Context, *File) (*UploadTask, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTemporaryUpload not implemented")
}
func (UnimplementedPubUserFileServer) ReportPreviewStatus(context.Context, *PreviewStatus) (*PreviewStatus, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportPreviewStatus not implemented")
}
func (UnimplementedPubUserFileServer) GetFileSlicesDownloadInfo(context.Context, *SlicesDownloadInfoRequest) (*SlicesDownloadInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFileSlicesDownloadInfo not implemented")
}
func (UnimplementedPubUserFileServer) ListRecentUpdatedFiles(context.Context, *ListRecentUpdatedFilesRequest) (*FileListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListRecentUpdatedFiles not implemented")
}
...
func RegisterPubUserFileServer(s grpc.ServiceRegistrar, srv PubUserFileServer) {
	// If the following call panics, it indicates UnimplementedPubUserFileServer was
...
func _PubUserFile_GetDirectDownloadAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(PubUserFileServer).GetDirectDownloadAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _PubUserFile_ListRecentUpdatedFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRecentUpdatedFilesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PubUserFileServer).ListRecentUpdatedFiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PubUserFile_ListRecentUpdatedFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PubUserFileServer).ListRecentUpdatedFiles(ctx, req.(*ListRecentUpdatedFilesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PubUserFile_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDirectDownloadAddress",
			Handler:    _PubUserFile_GetDirectDownloadAddress_Handler,
		},
		{
		...
		{
			MethodName: "ListRecentUpdatedFiles",
			Handler:    _PubUserFile_ListRecentUpdatedFiles_Handler,
		},
	},

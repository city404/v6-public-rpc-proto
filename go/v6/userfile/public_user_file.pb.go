...
type RTCFileResponse struct {
	...
	Sdp             []string `protobuf:"bytes,4,rep,name=sdp,proto3" json:"sdp,omitempty"`
...
var file_userfile_public_user_file_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x73, 0x64, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xac, 0x09,
	...
	0x12, 0x5a, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f,
	0x61, 0x64, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x12, 0x1f, 0x2e, 0x76, 0x36, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x70, 0x75, 0x62, 0x2e, 0x52, 0x54, 0x43, 0x46, 0x69, 0x6c,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x76, 0x36, 0x2e, 0x73, 0x65,
...
var file_userfile_public_user_file_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_userfile_public_user_file_proto_goTypes = []interface{}{
	...
	(*common.ScanListRequest)(nil), // 8: v6.services.pub.common.ScanListRequest
}
var file_userfile_public_user_file_proto_depIdxs = []int32{
	...
	8,  // 2: v6.services.pub.FileListRequest.list_info:type_name -> v6.services.pub.common.ScanListRequest
	8,  // 3: v6.services.pub.SearchRequest.list_info:type_name -> v6.services.pub.common.ScanListRequest
	0,  // 4: v6.services.pub.FileListResponse.files:type_name -> v6.services.pub.File
	8,  // 5: v6.services.pub.FileListResponse.list_info:type_name -> v6.services.pub.common.ScanListRequest
	...
	0,  // 22: v6.services.pub.PubUserFile.Create:output_type -> v6.services.pub.File
	0,  // 23: v6.services.pub.PubUserFile.Get:output_type -> v6.services.pub.File
	5,  // 24: v6.services.pub.PubUserFile.Rename:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 25: v6.services.pub.PubUserFile.Trash:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 26: v6.services.pub.PubUserFile.Move:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 27: v6.services.pub.PubUserFile.Copy:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 28: v6.services.pub.PubUserFile.Delete:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 29: v6.services.pub.PubUserFile.DeleteTrash:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 30: v6.services.pub.PubUserFile.Recover:output_type -> v6.services.pub.BatchOperationResponse
	5,  // 31: v6.services.pub.PubUserFile.BatchOperation:output_type -> v6.services.pub.BatchOperationResponse
	3,  // 32: v6.services.pub.PubUserFile.List:output_type -> v6.services.pub.FileListResponse
	3,  // 33: v6.services.pub.PubUserFile.ListTrash:output_type -> v6.services.pub.FileListResponse
	3,  // 34: v6.services.pub.PubUserFile.Search:output_type -> v6.services.pub.FileListResponse
	7,  // 35: v6.services.pub.PubUserFile.CreateDownloadOffer:output_type -> v6.services.pub.RTCFileResponse

...
var file_userfile_public_user_file_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x32, 0xa1, 0x05, 0x0a, 0x0b, 0x50, 0x75, 0x62, 0x55, 0x73, 0x65, 0x72, 0x46, 0x69,
	...
	0x22, 0x00, 0x12, 0x63, 0x0a, 0x0e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x65, 0x72, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x2e, 0x76, 0x36, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x70, 0x75, 0x62, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x65, 0x72,
	...
	0x62, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_userfile_public_user_file_proto_depIdxs = []int32{
	...
	3,  // 13: v6.services.pub.PubUserFile.BatchOperation:input_type -> v6.services.pub.BatchOperationRequest
	1,  // 14: v6.services.pub.PubUserFile.List:input_type -> v6.services.pub.FileListRequest
	0,  // 15: v6.services.pub.PubUserFile.Create:output_type -> v6.services.pub.File
	0,  // 16: v6.services.pub.PubUserFile.Get:output_type -> v6.services.pub.File
	4,  // 17: v6.services.pub.PubUserFile.Trash:output_type -> v6.services.pub.BatchOperationResponse
	4,  // 18: v6.services.pub.PubUserFile.Move:output_type -> v6.services.pub.BatchOperationResponse
	4,  // 19: v6.services.pub.PubUserFile.Copy:output_type -> v6.services.pub.BatchOperationResponse
	4,  // 20: v6.services.pub.PubUserFile.Delete:output_type -> v6.services.pub.BatchOperationResponse
	4,  // 21: v6.services.pub.PubUserFile.BatchOperation:output_type -> v6.services.pub.BatchOperationResponse
	2,  // 22: v6.services.pub.PubUserFile.List:output_type -> v6.services.pub.FileListResponse

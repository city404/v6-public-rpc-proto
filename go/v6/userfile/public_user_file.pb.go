...
const file_userfile_public_user_file_proto_rawDesc = "" +
	...
	"\x17GetSliceDownloadAddress\x12,.v6.services.pub.SliceDownloadAddressRequest\x1a-.v6.services.pub.SliceDownloadAddressResponse\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/v6/userfile/get_slice_download_address\x12\x92\x01\n" +

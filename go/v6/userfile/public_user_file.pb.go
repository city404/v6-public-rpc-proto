...
func (x *ListRecentUpdatedFilesRequest) Reset() {
	*x = ListRecentUpdatedFilesRequest{}
	mi := &file_userfile_public_user_file_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListRecentUpdatedFilesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRecentUpdatedFilesRequest) ProtoMessage() {}

func (x *ListRecentUpdatedFilesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_userfile_public_user_file_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRecentUpdatedFilesRequest.ProtoReflect.Descriptor instead.
func (*ListRecentUpdatedFilesRequest) Descriptor() ([]byte, []int) {
	return file_userfile_public_user_file_proto_rawDescGZIP(), []int{4}
}

func (x *ListRecentUpdatedFilesRequest) GetParent() *File {
	if x != nil {
		return x.Parent
	}
	return nil
...
func (x *ListRecentUpdatedFilesRequest) GetStartTs() int64 {
	if x != nil {
		return x.StartTs
	}
	return 0
...
func (x *ListRecentUpdatedFilesRequest) GetListInfo() *common.ScanListRequest {
	if x != nil {
		return x.ListInfo
	}
	return nil
...
func (x *BatchOperationResponse) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *PreviewStatus) Reset() {
	*x = PreviewStatus{}
	mi := &file_userfile_public_user_file_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PreviewStatus) Descriptor() ([]byte, []int) {
	return file_userfile_public_user_file_proto_rawDescGZIP(), []int{26}
}
...
const file_userfile_public_user_file_proto_rawDesc = "" +
	...
	"\tlist_info\x18\x03 \x01(\v2'.v6.services.pub.common.ScanListRequestR\blistInfo\"\xaf\x01\n" +
	...
	"\x04flag\x18\x04 \x01(\x05R\x04flag\"\xaf\x01\n" +
	...
	"\bprogress\x18\x05 \x01(\x03R\bprogress\x12\x14\n" +
	"\x05total\x18\x06 \x01(\x03R\x05total\"c\n" +
	...
	"\x19GetFileSlicesDownloadInfo\x12*.v6.services.pub.SlicesDownloadInfoRequest\x1a+.v6.services.pub.SlicesDownloadInfoResponse\"5\x82\xd3\xe4\x93\x02/:\x01*\"*/v6/userfile/get_file_slices_download_info\x12\x9e\x01\n" +
	"\x16ListRecentUpdatedFiles\x12..v6.services.pub.ListRecentUpdatedFilesRequest\x1a!.v6.services.pub.FileListResponse\"1\x82\xd3\xe4\x93\x02+:\x01*\"&/v6/userfile/list_recent_updated_filesB7Z5github.com/city404/v6-public-rpc-proto/go/v6/userfileb\x06proto3"
...
var file_userfile_public_user_file_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_userfile_public_user_file_proto_goTypes = []any{
	...
	(*ListRecentUpdatedFilesRequest)(nil), // 4: v6.services.pub.ListRecentUpdatedFilesRequest
	(*SearchRequest)(nil),                 // 5: v6.services.pub.SearchRequest
	(*FileListResponse)(nil),              // 6: v6.services.pub.FileListResponse
	(*BatchOperationRequest)(nil),         // 7: v6.services.pub.BatchOperationRequest
	(*BatchOperationResponse)(nil),        // 8: v6.services.pub.BatchOperationResponse
	(*ManageRTCRequest)(nil),              // 9: v6.services.pub.ManageRTCRequest
	(*ManageRTCResponse)(nil),             // 10: v6.services.pub.ManageRTCResponse
	(*SendIceCandidateRequest)(nil),       // 11: v6.services.pub.SendIceCandidateRequest
	(*SendIceCandidateResponse)(nil),      // 12: v6.services.pub.SendIceCandidateResponse
	(*GetIceCandidateRequest)(nil),        // 13: v6.services.pub.GetIceCandidateRequest
	(*GetIceCandidateResponse)(nil),       // 14: v6.services.pub.GetIceCandidateResponse
	(*ParseFileSliceResponse)(nil),        // 15: v6.services.pub.ParseFileSliceResponse
	(*SliceSize)(nil),                     // 16: v6.services.pub.SliceSize
	(*SliceDownloadAddressRequest)(nil),   // 17: v6.services.pub.SliceDownloadAddressRequest
	(*SliceDownloadAddressResponse)(nil),  // 18: v6.services.pub.SliceDownloadAddressResponse
	(*FileDownloadAddressResponse)(nil),   // 19: v6.services.pub.FileDownloadAddressResponse
	(*SliceDownloadInfo)(nil),             // 20: v6.services.pub.SliceDownloadInfo
	(*DocFilePreview)(nil),                // 21: v6.services.pub.DocFilePreview
	(*DownloadAndPreviewInfo)(nil),        // 22: v6.services.pub.DownloadAndPreviewInfo
	(*UploadToken)(nil),                   // 23: v6.services.pub.UploadToken
	(*UploadTask)(nil),                    // 24: v6.services.pub.UploadTask
	(*DirectDownloadRequest)(nil),         // 25: v6.services.pub.DirectDownloadRequest
	(*PreviewStatus)(nil),                 // 26: v6.services.pub.PreviewStatus
	(*common.ScanListRequest)(nil),        // 27: v6.services.pub.common.ScanListRequest
}
var file_userfile_public_user_file_proto_depIdxs = []int32{
	...
	27, // 1: v6.services.pub.SlicesDownloadInfoRequest.list_info:type_name -> v6.services.pub.common.ScanListRequest
	20, // 2: v6.services.pub.SlicesDownloadInfoResponse.slices:type_name -> v6.services.pub.SliceDownloadInfo
	27, // 3: v6.services.pub.SlicesDownloadInfoResponse.list_info:type_name -> v6.services.pub.common.ScanListRequest
	...
	27, // 7: v6.services.pub.FileListRequest.list_info:type_name -> v6.services.pub.common.ScanListRequest
	2,  // 8: v6.services.pub.ListRecentUpdatedFilesRequest.parent:type_name -> v6.services.pub.File
	27, // 9: v6.services.pub.ListRecentUpdatedFilesRequest.list_info:type_name -> v6.services.pub.common.ScanListRequest
	27, // 10: v6.services.pub.SearchRequest.list_info:type_name -> v6.services.pub.common.ScanListRequest
	2,  // 11: v6.services.pub.FileListResponse.files:type_name -> v6.services.pub.File
	27, // 12: v6.services.pub.FileListResponse.list_info:type_name -> v6.services.pub.common.ScanListRequest
	2,  // 13: v6.services.pub.BatchOperationRequest.source:type_name -> v6.services.pub.File
	2,  // 14: v6.services.pub.BatchOperationRequest.dest:type_name -> v6.services.pub.File
	16, // 15: v6.services.pub.ParseFileSliceResponse.sizes:type_name -> v6.services.pub.SliceSize
	20, // 16: v6.services.pub.ParseFileSliceResponse.raw_download_addresses:type_name -> v6.services.pub.SliceDownloadInfo
	20, // 17: v6.services.pub.SliceDownloadAddressResponse.addresses:type_name -> v6.services.pub.SliceDownloadInfo
	2,  // 18: v6.services.pub.PubUserFile.Create:input_type -> v6.services.pub.File
	2,  // 19: v6.services.pub.PubUserFile.Get:input_type -> v6.services.pub.File
	2,  // 20: v6.services.pub.PubUserFile.Rename:input_type -> v6.services.pub.File
	7,  // 21: v6.services.pub.PubUserFile.Trash:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 22: v6.services.pub.PubUserFile.Move:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 23: v6.services.pub.PubUserFile.Copy:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 24: v6.services.pub.PubUserFile.Delete:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 25: v6.services.pub.PubUserFile.DeleteTrash:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 26: v6.services.pub.PubUserFile.Recover:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 27: v6.services.pub.PubUserFile.BatchRename:input_type -> v6.services.pub.BatchOperationRequest
	7,  // 28: v6.services.pub.PubUserFile.BatchOperation:input_type -> v6.services.pub.BatchOperationRequest
	3,  // 29: v6.services.pub.PubUserFile.List:input_type -> v6.services.pub.FileListRequest
	3,  // 30: v6.services.pub.PubUserFile.ListTrash:input_type -> v6.services.pub.FileListRequest
	5,  // 31: v6.services.pub.PubUserFile.Search:input_type -> v6.services.pub.SearchRequest
	9,  // 32: v6.services.pub.PubUserFile.CreateManageRTCOffer:input_type -> v6.services.pub.ManageRTCRequest
	11, // 33: v6.services.pub.PubUserFile.SendClientIceCandidate:input_type -> v6.services.pub.SendIceCandidateRequest
	13, // 34: v6.services.pub.PubUserFile.GetServerIceCandidate:input_type -> v6.services.pub.GetIceCandidateRequest
	2,  // 35: v6.services.pub.PubUserFile.ParseFileSlice:input_type -> v6.services.pub.File
	17, // 36: v6.services.pub.PubUserFile.GetSliceDownloadAddress:input_type -> v6.services.pub.SliceDownloadAddressRequest
	25, // 37: v6.services.pub.PubUserFile.GetDirectDownloadAddress:input_type -> v6.services.pub.DirectDownloadRequest
	2,  // 38: v6.services.pub.PubUserFile.GetDownloadAndPreviewInfo:input_type -> v6.services.pub.File
	2,  // 39: v6.services.pub.PubUserFile.PreviewDoc:input_type -> v6.services.pub.File
	2,  // 40: v6.services.pub.PubUserFile.CreateDoc:input_type -> v6.services.pub.File
	2,  // 41: v6.services.pub.PubUserFile.CreateUploadToken:input_type -> v6.services.pub.File
	2,  // 42: v6.services.pub.PubUserFile.CreateUploadTask:input_type -> v6.services.pub.File
	2,  // 43: v6.services.pub.PubUserFile.CreateTemporaryUpload:input_type -> v6.services.pub.File
	26, // 44: v6.services.pub.PubUserFile.ReportPreviewStatus:input_type -> v6.services.pub.PreviewStatus
	0,  // 45: v6.services.pub.PubUserFile.GetFileSlicesDownloadInfo:input_type -> v6.services.pub.SlicesDownloadInfoRequest
	4,  // 46: v6.services.pub.PubUserFile.ListRecentUpdatedFiles:input_type -> v6.services.pub.ListRecentUpdatedFilesRequest
	2,  // 47: v6.services.pub.PubUserFile.Create:output_type -> v6.services.pub.File
	2,  // 48: v6.services.pub.PubUserFile.Get:output_type -> v6.services.pub.File
	8,  // 49: v6.services.pub.PubUserFile.Rename:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 50: v6.services.pub.PubUserFile.Trash:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 51: v6.services.pub.PubUserFile.Move:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 52: v6.services.pub.PubUserFile.Copy:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 53: v6.services.pub.PubUserFile.Delete:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 54: v6.services.pub.PubUserFile.DeleteTrash:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 55: v6.services.pub.PubUserFile.Recover:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 56: v6.services.pub.PubUserFile.BatchRename:output_type -> v6.services.pub.BatchOperationResponse
	8,  // 57: v6.services.pub.PubUserFile.BatchOperation:output_type -> v6.services.pub.BatchOperationResponse
	6,  // 58: v6.services.pub.PubUserFile.List:output_type -> v6.services.pub.FileListResponse
	6,  // 59: v6.services.pub.PubUserFile.ListTrash:output_type -> v6.services.pub.FileListResponse
	6,  // 60: v6.services.pub.PubUserFile.Search:output_type -> v6.services.pub.FileListResponse
	10, // 61: v6.services.pub.PubUserFile.CreateManageRTCOffer:output_type -> v6.services.pub.ManageRTCResponse
	12, // 62: v6.services.pub.PubUserFile.SendClientIceCandidate:output_type -> v6.services.pub.SendIceCandidateResponse
	14, // 63: v6.services.pub.PubUserFile.GetServerIceCandidate:output_type -> v6.services.pub.GetIceCandidateResponse
	15, // 64: v6.services.pub.PubUserFile.ParseFileSlice:output_type -> v6.services.pub.ParseFileSliceResponse
	18, // 65: v6.services.pub.PubUserFile.GetSliceDownloadAddress:output_type -> v6.services.pub.SliceDownloadAddressResponse
	19, // 66: v6.services.pub.PubUserFile.GetDirectDownloadAddress:output_type -> v6.services.pub.FileDownloadAddressResponse
	22, // 67: v6.services.pub.PubUserFile.GetDownloadAndPreviewInfo:output_type -> v6.services.pub.DownloadAndPreviewInfo
	21, // 68: v6.services.pub.PubUserFile.PreviewDoc:output_type -> v6.services.pub.DocFilePreview
	21, // 69: v6.services.pub.PubUserFile.CreateDoc:output_type -> v6.services.pub.DocFilePreview
	23, // 70: v6.services.pub.PubUserFile.CreateUploadToken:output_type -> v6.services.pub.UploadToken
	24, // 71: v6.services.pub.PubUserFile.CreateUploadTask:output_type -> v6.services.pub.UploadTask
	24, // 72: v6.services.pub.PubUserFile.CreateTemporaryUpload:output_type -> v6.services.pub.UploadTask
	26, // 73: v6.services.pub.PubUserFile.ReportPreviewStatus:output_type -> v6.services.pub.PreviewStatus
	1,  // 74: v6.services.pub.PubUserFile.GetFileSlicesDownloadInfo:output_type -> v6.services.pub.SlicesDownloadInfoResponse
	6,  // 75: v6.services.pub.PubUserFile.ListRecentUpdatedFiles:output_type -> v6.services.pub.FileListResponse
